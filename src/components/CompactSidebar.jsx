...
const CompactSidebar = ({ activeModal, onSearchClick, onNotificationClick, onBackToNormal }) => {
  return (
    <div className="w-auto px-3 py-6 bg-black inline-flex flex-col justify-start items-start gap-6 z-30">
      <div className="px-3 inline-flex justify-start items-center gap-2.5 overflow-hidden">
      ...
      <div className="flex flex-col justify-start items-start gap-1">
        ...
        <div className={`h-12 p-3 bg-black rounded-lg inline-flex justify-start items-center gap-2.5 overflow-hidden cursor-pointer hover:bg-neutral-800 transition-colors ${activeModal === 'search' ? 'outline outline-2 outline-offset-[-2px] outline-neutral-300' : ''}`} onClick={onSearchClick}>
          <div data-svg-wrapper="true">
        ...
        {/* Explore */}
        <div className="h-12 p-3 bg-black rounded-lg inline-flex justify-start items-center gap-2.5 overflow-hidden cursor-pointer hover:bg-neutral-800 transition-colors">
          <div data-svg-wrapper="true">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
